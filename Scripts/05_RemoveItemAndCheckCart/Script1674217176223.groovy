...
WebUI.verifyElementNotPresent(findTestObject('Page_Swag Labs/div_1Sauce Labs Backpackcarry.allTheThings() with the sleek, streamlined Sly Pack that melds uncompromising style with unequaled laptop and tablet protection.29.99Remove'), 
    0)
